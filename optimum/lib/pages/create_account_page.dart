...
class MyDropdownPage extends StatefulWidget {
  ...
  MyDropdownPage({super.key, required this.onGenderSelected});
  @override
...
class _MyDropdownPageState extends State<MyDropdownPage> {
  ...
  void dropdownCallback(String? selectedValue) {
    if (selectedValue != null && selectedValue != "") {
      ...
      widget.onGenderSelected(selectedValue); // Call the selected callback
    }
  }
    ...
    return Center(
      child: Padding(
        ...
        child: DropdownButton(
          ...
          iconEnabledColor: const Color(0xFFD37777),
          iconSize: 26.0,
          icon: const Icon(
