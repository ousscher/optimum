      ...
      body: Container(
          ...
          child: Column(
            children: <Widget>[
              ...
              Padding(
                padding: EdgeInsets.fromLTRB(0, screenSize.height * 0.07, screenSize.width * 0.15, 0),
                child: Column(
              ...
              Padding(
                padding: EdgeInsets.fromLTRB(screenSize.width * 0.07, 0, screenSize.width * 0.12, 0),
                child: Row(
